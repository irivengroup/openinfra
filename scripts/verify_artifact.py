...
class SourceDistributionVerifier:
    REQUIRED_SUFFIXES = (
        ...
        "docs/specifications/OpenInfra-CDC-SFG-STG-v4.10.0/VERSION",
        "docs/specifications/OpenInfra-CDC-SFG-STG-v4.10.0/scripts/validate_runtime_licensing.py",
        "docs/specifications/OpenInfra-Roadmap-Developpement-v2.3/VERSION",
        "docs/specifications/OpenInfra-Roadmap-Developpement-v2.3/scripts/validate_roadmap.py",
