# Changelog roadmap OpenInfra 2.5.0

## 2.5.0

- ajoute P25, REL-15, EPIC-2501 à EPIC-2504, M17 et GATE-14 ;
- ajoute six tests de roadmap couvrant les contrôles GATE-14 ;
- aligne REQ-00861 et TST-COMP-164 sur le registre exhaustif ;
- conserve les phases, releases et décisions historiques sans réaffectation fonctionnelle.

## v2.4.0 / OpenInfra 0.34.6 — RSOT canonique définitif

- ajoute P24, REL-14, EPIC-2401 à EPIC-2404, M16, GATE-13 et RSK-025 ;
- ajoute quatre validations P24 et l’alignement REQ-00860 ;
- ajoute le plan de migration des alias ITRM/RI/SOT vers RSOT ;
- conserve intégralement la roadmap 2.3.0 comme historique.

## 2.3.0 / CDC 4.10.0 / OpenInfra 0.34.5

- Ajout de P23, REL-13, M15 et GATE-12 pour la licence runtime offline Pro/Entreprise.
- Ajout des EPIC-2301 à EPIC-2304 et de huit tests de qualification couvrant cryptographie, trois backends, enforcement, interfaces, installateurs, frontend et packaging.
- Alignement explicite de REQ-00846 à REQ-00859.
- Normalisation de tous les CSV et correction de la colonne anonyme historique d’EPIC-2204 sans modifier son sens.
- Maintien des phases P00 à P22 et de la roadmap 2.2.0 dans son dossier historique.

## 2.2.0 / CDC 4.9.0 / OpenInfra 0.33.0

- Ajout de P21, REL-11, M13 et GATE-10 pour Kubernetes & Cloud-native.
- EPIC-2101 livre l’inventaire Kubernetes versionné et le mapping physique jusqu’au site.
- Planification des expositions, corrélations sécurité, GitOps drift et capacité sans dupliquer les socles Discovery, RSOT, SBOM ou Scale-out.
- Alignement explicite de REQ-00469 et REQ-00470.
