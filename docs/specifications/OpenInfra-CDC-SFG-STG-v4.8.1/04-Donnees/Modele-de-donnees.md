...
Le dictionnaire complet est disponible dans `04-Donnees/Dictionnaire.csv`. Il contient 319 entités logiques couvrant core, Source of Truth, DCIM, IPAM, discovery, dependency mapping, ITAM, sécurité, exploitation et IA.
