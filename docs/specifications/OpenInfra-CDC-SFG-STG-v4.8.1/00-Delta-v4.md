...
**Version :** 4.0.0  
**Objectif :** intégrer les améliorations fonctionnelles de niveau enterprise au dossier SFG/STG v3 sans modifier l’exclusion ITSM.
...
- Le périmètre RSOT (Ressource Source of Truth) est enrichi par la gouvernance, la qualité et la certification des données.
