...
Les agents sont de simples collecteurs d'informations destinés à alimenter la base centrale via l'API backend. Ils ne sont pas une RSOT (Ressource Source of Truth) locale.
...
- exposer les modules RSOT (Ressource Source of Truth), DCIM, ITAM, IPAM, Discovery, Dependency Mapping, sécurité, gouvernance, qualité, support constructeur, licences et connecteurs ;
