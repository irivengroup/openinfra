...
OpenInfra doit être une plateforme open source d’enterprise jouant le rôle de **référentiel central d’infrastructure** et de **Source of Truth** pour les actifs physiques, virtuels, cloud, réseau, applicatifs, logiciels, IP, dépendances, localisations, contrats et capacités.
...
OpenInfra doit être une solution open source d’enterprise, robuste et complète, couvrant Source of Truth, DCIM, ITAM, SAM, Discovery, Dependency Mapping et IPAM avancé, sans intégrer de fonction ITSM native.
