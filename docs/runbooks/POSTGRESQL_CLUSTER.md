...
## Migration 0008 Gouvernance des sources RSOT
...
Les index couvrent la recherche par type d'objet, chemin d'attribut, source autoritative et audit `rsot.governance.%`. Les opérations applicatives doivent rester transactionnelles avec la mise à jour RSOT afin d'éviter toute divergence entre décision de gouvernance, versionnement et audit.
