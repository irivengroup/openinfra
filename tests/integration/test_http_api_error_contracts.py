...
def test_http_api_error_contracts_cover_all_routes(tmp_path: Path) -> None:
    ...
    try:
        ...
        for route in (
            ...
            "/api/v1/ri/governance-rules",
            "/api/v1/ri/objects",
            "/api/v1/ri/object-versions",
            "/api/v1/ri/relations",
        ...
        bad_posts: tuple[tuple[str, dict[str, object], str | None], ...] = (
            ...
            ("/api/v1/ri/governance-rules", {}, admin_token),
            ("/api/v1/ri/governance/evaluate", {}, admin_token),
            ("/api/v1/ri/governance/deactivate-rule", {}, admin_token),
            ("/api/v1/ri/objects", {"tenant_id": "default", "tags": "bad"}, admin_token),
            ("/api/v1/ri/relations", {}, admin_token),
...
def test_http_api_authenticated_bad_request_branches_and_entrypoint(
    ...
    try:
        ...
        bad_gets = (
            ...
            "/api/v1/ri/governance-rules?tenant_id=default&limit=bad",
            "/api/v1/ri/objects?tenant_id=default&limit=bad",
            "/api/v1/ri/object-versions?tenant_id=default&key=x&version=bad",
            "/api/v1/ri/relations?tenant_id=default&limit=bad",
        )
