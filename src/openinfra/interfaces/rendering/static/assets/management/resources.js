import { orderManagementContextEntries } from './context-hierarchy.js';

export {
  managementContextLevel,
...
const RESOURCE_DEFINITIONS = [
  {
    ...
    filters: [['organization_id', 'Organisation'], ['tenant_id', 'Filiale/Subdivision'], ['country', 'Pays'], ['city', 'Ville'], ['status', 'Statut']],
  },
  {
    ...
    filters: [['organization_id', 'Organisation'], ['tenant_id', 'Filiale/Subdivision'], ['site', 'Site'], ['building_type', 'Type'], ['status', 'Statut']],
  },
  {
    ...
    filters: [['organization_id', 'Organisation'], ['tenant_id', 'Filiale/Subdivision'], ['site', 'Site'], ['building', 'Bâtiment'], ['floor', 'Étage'], ['status', 'Statut']],
  },
  {
    ...
    filters: [['organization_id', 'Organisation'], ['tenant_id', 'Filiale/Subdivision'], ['site', 'Site'], ['building', 'Bâtiment'], ['floor', 'Étage'], ['room', 'Salle'], ['row', 'Ligne'], ['column', 'Colonne'], ['status', 'Statut']]
  },
  {
    ...
    filters: [['organization_id', 'Organisation'], ['tenant_id', 'Filiale/Subdivision'], ['site', 'Site'], ['building', 'Bâtiment'], ['floor', 'Étage'], ['room', 'Salle'], ['rows', 'Ligne'], ['columns', 'Colonne'], ['status', 'Statut']]
  },
  {
...
export const MANAGEMENT_RESOURCES = Object.freeze(RESOURCE_DEFINITIONS.map((resource) => Object.freeze({
  ...
  filters: Object.freeze(orderManagementContextEntries(resource.filters.map(([key, label]) => Object.freeze({ key, label })))),
})));
...
export function flattenManagementCollection(resource, payload, scope = {}) {
  if (!payload || typeof payload !== 'object') return [];
  const withScope = (item) => ({
