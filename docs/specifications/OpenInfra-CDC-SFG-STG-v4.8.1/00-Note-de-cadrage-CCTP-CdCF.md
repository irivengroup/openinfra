...
OpenInfra doit être une plateforme open source de référence d’infrastructure, couvrant RSOT (Ressource Source of Truth), DCIM, ITAM, Discovery, Dependency Mapping et IPAM Enterprise++, sans fonction ITSM intégrée.
