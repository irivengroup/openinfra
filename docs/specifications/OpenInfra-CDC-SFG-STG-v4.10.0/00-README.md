...
Le CDC 4.10.0 est la référence contractuelle consolidée pour OpenInfra Lite, Pro et Entreprise. Il conserve intégralement le CDC 4.9.0 et ajoute la licence runtime offline des éditions commerciales, la migration 0059 et la qualification GATE-12.
...
## Architecture haute performance héritée de 4.9.0
...
- [Delta v4.10](00-Delta-v4.10.md)
- [Delta v4.9 historique](00-Delta-v4.9.md)
...
- [ADR licence offline](08-RFC-ADR/ADR-0021-Licence-runtime-offline.md)
- [Licence runtime offline](03-Technique/19-Licence-runtime-offline.md)
...
```bash
python docs/specifications/OpenInfra-CDC-SFG-STG-v4.10.0/scripts/validate_docs.py
python docs/specifications/OpenInfra-CDC-SFG-STG-v4.10.0/scripts/validate_runtime_licensing.py
