...
const OPENINFRA_DOMAIN_LOADERS = {
  "rsot": () => import("./domains/rsot.js?v=0.33.1"),
  "ipam": () => import("./domains/ipam.js?v=0.33.1"),
  "dcim": () => import("./domains/dcim.js?v=0.33.1"),
  "itam": () => import("./domains/itam.js?v=0.33.1"),
  "discovery": () => import("./domains/discovery.js?v=0.33.1"),
  "data": () => import("./domains/data.js?v=0.33.1"),
  "integrations": () => import("./domains/integrations.js?v=0.33.1"),
  "security": () => import("./domains/security.js?v=0.33.1"),
};
