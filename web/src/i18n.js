...
const UI_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    skipToNavigation: 'Skip to component navigation',
    skipToSearch: 'Skip to global search',
    componentNavigationInstructions: 'Use Left and Right Arrow keys to move between components. Use Down Arrow or Enter to open a component menu.',
    accessibilityStatus: 'Accessibility status',
    navigationOpened: '{component} menu opened.',
    navigationClosed: 'Navigation menu closed.',
    operationSelected: '{operation} selected.',
    requiredFieldsNotice: 'Fields marked required must be completed before execution.',
    ...
    runtimeLicense: 'Runtime license',
    licenseStatus: 'Status',
    licenseCompany: 'Company',
    licenseHosts: 'Managed hosts',
    licenseExpires: 'Expires',
    licenseGraceUntil: 'Grace period until',
    licenseUnavailable: 'Runtime license status is temporarily unavailable.',
    licenseStatus_not_required: 'not required',
    licenseStatus_missing: 'missing',
    licenseStatus_active: 'active',
    licenseStatus_grace: 'grace period',
    licenseStatus_expired: 'expired',
    licenseStatus_invalid: 'invalid',
    forms: 'Forms',
    modules: 'Modules',
    ...
    resultTitle: 'Result',
    rawResult: 'Raw JSON result',
    graphVisualization: 'Dependency visualization',
    graphVisualizationDescription: 'Layered, keyboard-accessible view. Labels and the raw result remain available without relying on color.',
    graphNodesOmitted: '{count} additional nodes are available in the raw result.',
    noGraphData: 'No graph data to display.',
    spofRanking: 'Single points of failure ranking',
    candidate: 'Candidate',
    affectedNodes: 'Affected nodes',
    directAffected: 'Directly affected',
    impactRatio: 'Impact ratio',
    affectedSample: 'Affected sample',
    completeAnalysis: 'Complete analysis',
    boundedAnalysis: 'Bounded analysis',
    noSpofDetected: 'No single point of failure detected for these filters.',
    changeImpactReport: 'Application change impact report',
    impactedBusinessServices: 'Impacted business services',
    criticalDependencies: 'Critical dependencies',
    rootSpofRisk: 'Root single point of failure risk',
    riskLevel: 'Risk level',
    graphDepth: 'Graph depth',
    timeTravelReport: 'Historical time-travel report',
    completeHistoricalState: 'Complete historical state',
    boundedHistoricalState: 'Bounded historical state',
    historicalObject: 'Historical object',
    requestedAt: 'Requested point in time',
    resolvedVersion: 'Resolved version',
    provenance: 'Provenance',
    sourceSystem: 'Source system',
    snapshotChangedBy: 'Snapshot changed by',
    snapshotChangedAt: 'Snapshot changed at',
    snapshotIdentifier: 'Snapshot identifier',
    historicalRelations: 'Historical relations',
    relationType: 'Relation type',
    sourceObject: 'Source object',
    targetObject: 'Target object',
    validityWindow: 'Validity window',
    noHistoricalRelations: 'No relation was valid at the requested point in time.',
    downloadReady: 'Export downloaded',
    ...
    managementSubtitle: '{operation} — unified lifecycle management workspace.',
    managementWorkspace: 'Management workspace',
    managementDescription: 'Search, filter, inspect and manage all {resource} from one consolidated workspace.',
    managementUnavailable: 'This management workspace is unavailable for the current catalog.',
    managementFilters: 'Management filters',
    managementFilterTitle: 'Search and filters',
    managementFilterDescription: 'Combine the relevant context and business criteria to refine the managed objects.',
    managementContextFilters: 'Parent context',
    managementBusinessFilters: 'Business criteria',
    managementNoFilterValues: 'No value available',
    selectParentContextFirst: 'Select the parent context first',
    managementSearchPlaceholder: 'Search across all visible fields…',
    loadingManagementData: 'Loading managed objects…',
    managementResults: '{count} objects',
    managementRange: '{first}–{last} of {total}',
    noManagementResults: 'No object matches the current filters.',
    allValues: 'All',
    includeRetired: 'Include retired objects',
    ...
    createManagementItem: 'Create {item}',
    editManagementItem: 'Edit {item}',
    createManagementDescription: 'Complete the business fields below. After creation, you will return to the management list.',
    editManagementDescription: 'Update the permitted fields below. Immutable identifiers are kept unchanged.',
    loadingDetails: 'Loading object details…',
    confirmDeletion: 'Confirm deletion',
    deleteManagementConfirmation: 'Delete {item}?',
    deleteManagementLifecycleNotice: 'The backend lifecycle policy remains authoritative; when supported, deletion is implemented as a governed retirement.',
    managementCreated: 'Object created successfully.',
    managementUpdated: 'Object updated successfully.',
    managementDeleted: 'Object deleted successfully.',
    ...
    loadingFormReferences: 'Loading form reference data…',
    ...
    invalidField: 'Invalid value: {field}',
    invalidText: 'Invalid text or unsupported characters: {field}',
    invalidEmail: 'Invalid email address: {field}',
    invalidPhone: 'Invalid phone number: {field}',
    invalidPostalCode: 'Invalid postal code: {field}',
    invalidIp: 'Invalid IPv4 or IPv6 address: {field}',
    invalidCidr: 'Invalid IPv4 or IPv6 network prefix: {field}',
    invalidMac: 'Invalid MAC address: {field}',
    invalidHostname: 'Invalid host name: {field}',
    invalidUrl: 'Invalid HTTP or HTTPS URL: {field}',
    invalidDate: 'Invalid date: {field}',
    invalidDatetime: 'Invalid date and time: {field}',
    invalidJson: 'Invalid JSON document: {field}',
    invalidCsv: 'Invalid comma-separated values: {field}',
  ...
  fr: Object.freeze({
    ...
    skipToNavigation: 'Aller à la navigation des composants',
    skipToSearch: 'Aller à la recherche globale',
    componentNavigationInstructions: 'Utilisez les flèches gauche et droite pour parcourir les composants. Utilisez la flèche bas ou Entrée pour ouvrir le menu d’un composant.',
    accessibilityStatus: 'État d’accessibilité',
    navigationOpened: 'Menu {component} ouvert.',
    navigationClosed: 'Menu de navigation fermé.',
    operationSelected: '{operation} sélectionnée.',
    requiredFieldsNotice: 'Les champs indiqués comme obligatoires doivent être renseignés avant l’exécution.',
    requiredIndicator: 'obligatoire',
    opensNewWindow: 's’ouvre dans un nouvel onglet',
    ...
    runtimeLicense: 'Licence runtime',
    licenseStatus: 'État',
    licenseCompany: 'Entreprise',
    licenseHosts: 'Hôtes gérés',
    licenseExpires: 'Expiration',
    licenseGraceUntil: 'Période de grâce jusqu’au',
    licenseUnavailable: 'L’état de la licence runtime est temporairement indisponible.',
    licenseStatus_not_required: 'non requise',
    licenseStatus_missing: 'absente',
    licenseStatus_active: 'active',
    licenseStatus_grace: 'période de grâce',
    licenseStatus_expired: 'expirée',
    licenseStatus_invalid: 'invalide',
    forms: 'Formulaires',
    modules: 'Modules',
    ...
    rawResult: 'Résultat JSON brut',
    graphVisualization: 'Visualisation des dépendances',
    graphVisualizationDescription: 'Vue en couches accessible au clavier. Les libellés et le résultat brut restent disponibles sans dépendre de la couleur.',
    graphNodesOmitted: '{count} nœuds supplémentaires sont disponibles dans le résultat brut.',
    noGraphData: 'Aucune donnée de graphe à afficher.',
    spofRanking: 'Classement des points uniques de défaillance',
    candidate: 'Candidat',
    affectedNodes: 'Objets affectés',
    directAffected: 'Affectés directement',
    impactRatio: 'Ratio d’impact',
    affectedSample: 'Échantillon affecté',
    completeAnalysis: 'Analyse complète',
    boundedAnalysis: 'Analyse bornée',
    noSpofDetected: 'Aucun point unique de défaillance détecté pour ces filtres.',
    changeImpactReport: 'Rapport d’impact du changement applicatif',
    impactedBusinessServices: 'Services métier affectés',
    criticalDependencies: 'Dépendances critiques',
    rootSpofRisk: 'Risque de point unique de défaillance racine',
    riskLevel: 'Niveau de risque',
    graphDepth: 'Profondeur du graphe',
    timeTravelReport: 'Rapport historique time travel',
    completeHistoricalState: 'État historique complet',
    boundedHistoricalState: 'État historique borné',
    historicalObject: 'Objet historique',
    requestedAt: 'Instant demandé',
    resolvedVersion: 'Version restituée',
    provenance: 'Provenance',
    sourceSystem: 'Système source',
    snapshotChangedBy: 'Snapshot modifié par',
    snapshotChangedAt: 'Snapshot modifié le',
    snapshotIdentifier: 'Identifiant du snapshot',
    historicalRelations: 'Relations historiques',
    relationType: 'Type de relation',
    sourceObject: 'Objet source',
    targetObject: 'Objet cible',
    validityWindow: 'Fenêtre de validité',
    noHistoricalRelations: 'Aucune relation n’était valide à l’instant demandé.',
    downloadReady: 'Export téléchargé',
    ...
    managementSubtitle: '{operation} — espace unifié de gestion du cycle de vie.',
    managementWorkspace: 'Espace de gestion',
    managementDescription: 'Recherchez, filtrez, consultez et gérez l’ensemble des {resource} depuis une page unique.',
    managementUnavailable: 'Cet espace de gestion n’est pas disponible pour le catalogue courant.',
    managementFilters: 'Filtres de gestion',
    managementFilterTitle: 'Recherche et filtres',
    managementFilterDescription: 'Combinez le contexte parent et les critères métier pertinents pour affiner les objets gérés.',
    managementContextFilters: 'Contexte parent',
    managementBusinessFilters: 'Critères métier',
    managementNoFilterValues: 'Aucune valeur disponible',
    selectParentContextFirst: 'Sélectionnez d’abord le contexte parent',
    managementSearchPlaceholder: 'Rechercher dans tous les champs visibles…',
    loadingManagementData: 'Chargement des objets gérés…',
    managementResults: '{count} objets',
    managementRange: '{first}–{last} sur {total}',
    noManagementResults: 'Aucun objet ne correspond aux filtres courants.',
    allValues: 'Tous',
    includeRetired: 'Inclure les objets retirés',
    ...
    createManagementItem: 'Créer {item}',
    editManagementItem: 'Modifier {item}',
    createManagementDescription: 'Renseignez les champs métier ci-dessous. Après création, vous serez redirigé vers la liste de gestion.',
    editManagementDescription: 'Modifiez les champs autorisés ci-dessous. Les identifiants immuables restent inchangés.',
    loadingDetails: 'Chargement des détails de l’objet…',
    confirmDeletion: 'Confirmer la suppression',
    deleteManagementConfirmation: 'Supprimer {item} ?',
    deleteManagementLifecycleNotice: 'La politique de cycle de vie du backend reste autoritaire ; lorsqu’il est prévu, l’effacement est réalisé sous forme de retrait gouverné.',
    managementCreated: 'Objet créé avec succès.',
    managementUpdated: 'Objet modifié avec succès.',
    managementDeleted: 'Objet supprimé avec succès.',
    ...
    loadingFormReferences: 'Chargement des référentiels du formulaire…',
    ...
    invalidField: 'Valeur invalide : {field}',
    invalidText: 'Texte invalide ou caractères non pris en charge : {field}',
    invalidEmail: 'Adresse email invalide : {field}',
    invalidPhone: 'Numéro de téléphone invalide : {field}',
    invalidPostalCode: 'Code postal invalide : {field}',
    invalidIp: 'Adresse IPv4 ou IPv6 invalide : {field}',
    invalidCidr: 'Préfixe réseau IPv4 ou IPv6 invalide : {field}',
    invalidMac: 'Adresse MAC invalide : {field}',
    invalidHostname: 'Nom d’hôte invalide : {field}',
    invalidUrl: 'URL HTTP ou HTTPS invalide : {field}',
    invalidDate: 'Date invalide : {field}',
    invalidDatetime: 'Date et heure invalides : {field}',
    invalidJson: 'Document JSON invalide : {field}',
    invalidCsv: 'Liste de valeurs séparées par des virgules invalide : {field}',
...
const MODULE_DESCRIPTION_EN = Object.freeze({
  ...
  graph: 'Tenant-aware RSOT dependency traversal, impact analysis, SPOF detection and governed exports.',
...
const FIELD_EN = Object.freeze({
  ...
  root_key: 'Root resource', source_key: 'Source resource', target_key: 'Target resource',
  direction: 'Direction', max_depth: 'Maximum depth', max_nodes: 'Maximum nodes',
  relation_type: 'Relationship type', candidate_kind: 'Candidate kind',
  candidate_resource_category: 'Candidate resource category', candidate_resource_type: 'Candidate resource type',
  candidate_status: 'Candidate status', minimum_affected_nodes: 'Minimum affected nodes',
  affected_sample_limit: 'Affected sample limit', cursor: 'Cursor', format: 'Export format',
  include_spof: 'Include SPOFs',
  ...
  selector_key: 'Selector key', fixed_target: 'Fixed target', percentage: 'Percentage',
  category: 'Cost category', active_only: 'Active only', include_records: 'Include records',
  records: 'Cost records JSON', period_start: 'Period start', period_end: 'Period end',
  currency: 'ISO-4217 currency', quality_status: 'Allocation quality', amount: 'Amount',
...
const PHRASE_EN = Object.freeze({
  ...
  'Région': 'Region', 'VRF': 'VRF', 'ID agent régional': 'Regional agent ID', 'ID route': 'Route ID', 'Routes actives uniquement': 'Active routes only', 'Type de job': 'Job type', 'Cible': 'Target', 'Tentatives maximales': 'Maximum attempts',
  ...
  'Conformité des flux': 'Flow compliance', 'Conformité réseau': 'Network compliance',
...
const OPTION_FR = Object.freeze({
  outgoing: 'Sortant', incoming: 'Entrant', both: 'Les deux',
...
function operationLabelEn(operationId) {
  const overrides = {
    ...
    'graph-traverse': 'Explore dependency graph', 'graph-impact': 'Analyze impact', 'graph-change-impact': 'Analyze application change impact',
    'graph-path': 'Find shortest dependency path',
    'graph-spof': 'Detect single points of failure',
    'graph-export': 'Export dependency graph',
    'simulation-create': 'Create change scenario',
    'simulation-list': 'List scenarios',
    'simulation-run': 'Calculate scenario impact',
    'simulation-reports': 'List impact reports',
    'simulation-compare': 'Compare two reports',
    'simulation-comparisons': 'List comparisons',
    ...
    'finops-rule-create': 'Create allocation rule',
    'finops-rules': 'List allocation rules',
    'finops-import-submit': 'Submit cost import',
    'finops-import-get': 'View cost import',
    'finops-imports': 'List cost imports',
    'finops-import-run': 'Run cost import',
    'finops-import-cancel': 'Cancel cost import',
    'finops-costs': 'List normalized costs',
    'finops-budget-upsert': 'Create or revise budget',
    'finops-budgets': 'List budgets',
    'finops-period-close': 'Close financial period',
    'finops-periods': 'List financial periods',
    'finops-report-generate': 'Generate showback or chargeback',
    'finops-report-get': 'View financial report',
    'finops-reports': 'List financial reports',
    ...
    'multisite-dr-plan-configure': 'Configure multisite disaster-recovery plan',
    'multisite-dr-plan-disable': 'Disable multisite disaster-recovery plan',
    'multisite-dr-plans': 'List multisite disaster-recovery plans',
    'multisite-dr-plan-get': 'View multisite disaster-recovery plan',
    'multisite-dr-drill-execute': 'Record primary-site-loss disaster-recovery drill',
    'multisite-dr-drills': 'List multisite disaster-recovery drills',
    'multisite-dr-drill-get': 'View multisite disaster-recovery drill',
    'multisite-route-configure': 'Configure regional Discovery route',
    'multisite-route-disable': 'Disable regional Discovery route',
    'multisite-routes': 'List regional Discovery routes',
    'multisite-route-get': 'View regional Discovery route',
    'multisite-job-route': 'Route regional Discovery job',
