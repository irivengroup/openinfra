...
Les noms de services sont invariants entre éditions. Les ports internes restent gérés par l'installateur : `2006` back/front, `2007` back/agent-proxy, `2008` synchronisation cluster.
