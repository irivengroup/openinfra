import { OpenInfraI18n, localizeOpenInfraCatalog } from "./openinfra-i18n.js?v=0.30.6";
import {
  ...
  normalizeFieldValue,
  validateControl
} from "./openinfra-form-fields.js?v=0.30.6";
...
const OPENINFRA_MODULES = [
  ...
  { id: "ipam", label: "IPAM", icon: "grid", description: "IPv4/IPv6, VRF, préfixes, plages, VLAN/VXLAN, ASN/BGP, DNS/DHCP, DDI, conflits, capacité et allocations.", operations: [
    ...
    { id: "ipam-observe-dhcp", label: "Observer un bail DHCP", method: "POST", path: "/v1/ipam/dhcp-leases", body: [FIELD_SETS.actor, { name: "vrf", label: "VRF", required: true, placeholder: "global" }, { name: "prefix", label: "Préfixe", required: true, placeholder: "10.20.30.2/24" }, { name: "address", label: "Adresse IP", required: true, placeholder: "10.20.30.64" }, { name: "mac_address", label: "Adresse MAC", required: true, placeholder: "00:11:22:33:44:55" }, { name: "hostname", label: "Nom DHCP", required: true, placeholder: "srv-dhcp-01" }, { name: "source", label: "Source observation", placeholder: "kea" }, { name: "active", label: "Bail actif", type: "boolean", defaultValue: "true" }] },
    ...
    { id: "flow-observation-submit", label: "Ingérer un flux observé", method: "POST", path: "/v1/flows/observations/submit", body: [
      ...
      { name: "destination_ip", label: "IP destination", required: true, placeholder: "10.20.30.60" },
