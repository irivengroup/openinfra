...
class Permission(StrEnum):
    ...
    FINOPS_IMPORT = "finops.import"
    FINOPS_EXPORT = "finops.export"
    FINOPS_ADMIN = "finops.admin"
    GREENOPS_READ = "greenops.read"
    GREENOPS_WRITE = "greenops.write"
    GREENOPS_IMPORT = "greenops.import"
    GREENOPS_EXPORT = "greenops.export"
    GREENOPS_EXECUTE = "greenops.execute"
    GREENOPS_ADMIN = "greenops.admin"
    SBOM_READ = "sbom.read"
    SBOM_WRITE = "sbom.write"
    SBOM_IMPORT = "sbom.import"
    SBOM_EXPORT = "sbom.export"
    SBOM_EXECUTE = "sbom.execute"
    SBOM_ADMIN = "sbom.admin"
    RAG_READ = "rag.read"
    RAG_WRITE = "rag.write"
