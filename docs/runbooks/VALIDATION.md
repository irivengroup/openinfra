...
PYTHONPATH=src python scripts/validate_frontend.py --project-root .
node --check src/openinfra/interfaces/rendering/static/assets/openinfra-web.js
PYTHONPATH=src python -m openinfra.interfaces.cli spec validate --root docs/specifications/OpenInfra-CDC-SFG-STG-v4.10.0
PYTHONPATH=src python docs/specifications/OpenInfra-Roadmap-Developpement-v2.3/scripts/validate_roadmap.py --root docs/specifications/OpenInfra-Roadmap-Developpement-v2.3
```
...
PYTHONPATH=src python3 -m openinfra.interfaces.cli spec validate --root docs/specifications/OpenInfra-CDC-SFG-STG-v4.10.0
