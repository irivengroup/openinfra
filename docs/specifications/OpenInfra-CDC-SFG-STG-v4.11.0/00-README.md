...
Le CDC 4.11.0 est la référence contractuelle consolidée pour OpenInfra Lite, Pro et Entreprise. Il conserve intégralement le CDC 4.9.0 et conserve la licence runtime offline et finalise la canonicalisation RSOT en supprimant les alias ITRM, RI et SOT.
