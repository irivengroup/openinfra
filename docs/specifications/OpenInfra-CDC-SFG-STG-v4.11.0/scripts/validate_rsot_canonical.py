#!/usr/bin/env python3
"""Validate the definitive RSOT canonicalisation contract for CDC 4.11.0."""
...
if (CDC_ROOT / "VERSION").read_text(encoding="utf-8").strip() != "4.11.0":
    fail("CDC VERSION must be 4.11.0")
...
print(f"OK: CDC 4.11.0 RSOT canonicalisation validated - 6/6 controls, {EXPECTED_REQUIREMENT}, {EXPECTED_TEST}")
