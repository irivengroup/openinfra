...
def test_gate14_policy_and_real_project_pass() -> None:
    ...
    assert report.release_version == "0.34.22"
    assert report.metrics == Gate14Metrics(667, 32, 587, 48, 45, 78, 0, 0)
...
def test_gate14_report_serialization_and_atomic_write(
    ...
    report = Gate14Report(
        ...
        Gate14Metrics(667, 32, 587, 48, 45, 78, 0, 0),
...
def test_gate14_policy_rejects_invalid_contracts(tmp_path: Path) -> None:
    ...
    valid = {
        ...
        "expected_metrics": Gate14Metrics(667, 32, 587, 48, 45, 78, 0, 0).as_dict(),
    }
