...
const MODULES = [
  ...
  { id: 'itam', label: 'IT Asset Management', shortLabel: 'ITAM', icon: 'asset', operations: [
    { id: 'itam-tenants', label: 'Lister les tenants ITAM', path: '/v1/itam/tenants', method: 'GET', fields: ['Inclure retirés'] },
    { id: 'itam-tenant-create', label: 'Créer tenant ITAM', path: '/v1/itam/tenant/create', method: 'POST', fields: ['ID tenant', 'Opérateur', 'Tenant de sécurité', 'Nom tenant', 'Statut', 'Tenant par défaut', 'Description'] },
    { id: 'itam-tenant-update', label: 'Modifier tenant ITAM', path: '/v1/itam/tenant/update', method: 'POST', fields: ['Opérateur', 'Tenant de sécurité', 'Nom tenant', 'Statut', 'Tenant par défaut', 'Description'] },
    { id: 'itam-tenant-delete', label: 'Retirer tenant ITAM', path: '/v1/itam/tenant/delete', method: 'POST', fields: ['Opérateur', 'Tenant de sécurité'] },
