# OpenInfra — Roadmap de développement 2.3.0

La roadmap 2.3.0 est alignée sur le CDC/SFG/STG 4.10.0 et OpenInfra 0.34.5. Elle conserve intégralement les phases P00 à P22 de la roadmap 2.2.0 et ajoute un lot prioritaire transverse consacré au licensing runtime offline.
...
- CDC actif : `OpenInfra-CDC-SFG-STG-v4.10.0`
- Alignement : `14-alignement-cdc-v4.10.0.csv`
