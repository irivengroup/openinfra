import { OpenInfraI18n, localizeOpenInfraCatalog } from "./openinfra-i18n.js?v=0.34.2";
...
async function ensureManagementRegistryLoaded() {
  if (!managementRegistryPromise) {
    managementRegistryPromise = import("./management/resources.js?v=0.34.2").then((loaded) => {
...
import {
  ...
  normalizeFieldValue,
  validateControl
} from "./openinfra-form-fields.js?v=0.34.2";
import { OPENINFRA_DOMAIN_LOADERS, OPENINFRA_MODULES, OPENINFRA_SIDEBAR_CONTEXTS } from "./openinfra-domain-manifest.js?v=0.34.2";
import { OpenInfraQueryCache } from "./openinfra-query-cache.js?v=0.34.2";
import { OpenInfraVirtualList } from "./openinfra-virtual-list.js?v=0.34.2";
import { installOpenInfraWebVitals } from "./openinfra-web-vitals.js?v=0.34.2";
...
class OpenInfraDashboard {
  ...
  async loadSearchIndex() {
    ...
    const loaded = await import("./openinfra-search-index.js?v=0.34.2");
