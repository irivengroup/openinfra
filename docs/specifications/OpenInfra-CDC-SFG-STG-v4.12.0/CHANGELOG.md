## v4.11.0 / OpenInfra 0.34.6 — Canonicalisation RSOT définitive

- ajoute REQ-00860 et TST-RSOT-163 ;
- remplace la compatibilité temporaire ITRM/RI/SOT par leur retrait définitif ;
- ajoute la matrice RSOT v4.11, le guide de migration et la qualification GATE-13 ;
- conserve intégralement les décisions de licence runtime offline du CDC 4.10.0.

## v4.10.0 / OpenInfra 0.34.5 — Licence runtime offline et GATE-12

- ajoute REQ-00846 à REQ-00859 et TST-LIC-146 à TST-LIC-162 ;
- restaure TST-WEB-091, TST-WEB-092 et TST-WEB-095 ;
- complète les 23 lignes de traçabilité historiques manquantes ;
- impose Ed25519, binding entreprise/installation/édition/quota, grâce de 30 jours et anti-recul d’horloge ;
- ajoute la parité JSON/PostgreSQL/Oracle, la migration 0059, les interfaces, installateurs et notifications ;
- rend GATE-12 bloquant pour REL-13 sans modifier Lite, Oracle Enterprise-only ni le thème.

## v4.9.0 / OpenInfra 0.30.0 — Architecture haute performance Pro/Entreprise

- Runtime ASGI stateless et multiprocessus pour API et BFF Web.
- Pool PostgreSQL borné avec budget global par édition.
- Client HTTP BFF persistant, timeouts séparés et streaming.
- Ajout de douze exigences REQ-00829 à REQ-00840 et des validations TST-PERF-129 à TST-PERF-140.
- Cibles PgBouncer, réplicas de lecture, pagination curseur, outbox/workers et frontend modulaire séquencées dans la roadmap 2.1.0.
- Conservation du monolithe modulaire et de tous les contrats publics.
