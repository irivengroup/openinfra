...
- la chaîne PostgreSQL ne contient plus exactement 60 migrations terminant par `0060_ipam_ddi_execution_journal.sql`, après la preuve historique `0056_kubernetes_gitops_drift.sql`.
