...
def test_http_api_error_contracts_cover_all_routes(tmp_path: Path) -> None:
    ...
    try:
        ...
        bad_posts: tuple[tuple[str, dict[str, object], str | None], ...] = (
            ...
            ("/api/v1/itrm/governance-rules", {}, admin_token),
            ("/api/v1/itrm/governance/evaluate", {}, admin_token),
            ("/api/v1/itrm/governance/deactivate-rule", {}, admin_token),
            ("/api/v1/itrm/objects", {"tenant_id": "default", "tags": "bad"}, admin_token),
            ("/api/v1/itrm/relations", {}, admin_token),
...
def test_http_api_authenticated_bad_request_branches_and_entrypoint(
    ...
    try:
        ...
        bad_gets = (
            ...
            "/api/v1/itrm/governance-rules?tenant_id=default&limit=bad",
            "/api/v1/itrm/objects?tenant_id=default&limit=bad",
            "/api/v1/itrm/object-versions?tenant_id=default&key=x&version=bad",
            "/api/v1/itrm/relations?tenant_id=default&limit=bad",
        )
