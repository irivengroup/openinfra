...
```bash
sudo /opt/openinfra/venv/bin/python -m pip install '/opt/openinfra/openinfra-0.34.5-py3-none-any.whl[postgresql,advanced-identity]'
...
```bash
export GATE11_CANDIDATE_ID="openinfra-0.34.5-rc1"
