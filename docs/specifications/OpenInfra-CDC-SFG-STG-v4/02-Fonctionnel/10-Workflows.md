...
Les workflows pilotent validations, notifications, règles, automatisations non ITSM et approbations techniques.
...
Le périmètre Modèle de données complet du volume Référentiel Source of Truth doit être implémenté par une capacité documentée, exposée par API lorsque pertinent, sécurisée par RBAC et testée.
...
Le périmètre Gestion des équipements du volume Référentiel Source of Truth doit être implémenté par une capacité documentée, exposée par API lorsque pertinent, sécurisée par RBAC et testée.
...
Le périmètre Localisation X/Y/Z du volume Référentiel Source of Truth doit être implémenté par une capacité documentée, exposée par API lorsque pertinent, sécurisée par RBAC et testée.
...
Le périmètre Historique du volume Référentiel Source of Truth doit être implémenté par une capacité documentée, exposée par API lorsque pertinent, sécurisée par RBAC et testée.
