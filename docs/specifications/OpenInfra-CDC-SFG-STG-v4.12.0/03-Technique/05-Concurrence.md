...
Transactions courtes, verrous optimistes, idempotency keys, retry backoff, absence de verrou global, queues et bulkheads.
...
La concurrence est bornée à chaque niveau : load balancer, worker ASGI, pool HTTP, pool PostgreSQL, workers asynchrones et agents. Une saturation retourne une erreur explicite et observable plutôt que de créer des ressources sans limite. Les tests couvrent épuisement de pool, timeout d’acquisition, annulation client, arrêt gracieux et absence de fuite de connexion.
