...
class TestRuntimeEnvironment:
    ...
    def test_optional_docker_assets_remain_test_only(self) -> None:
        ...
        assert "OPENINFRA_IMAGE_TAG=0.29.35" in env_example
        ...
        assert "openinfra/runtime:${OPENINFRA_IMAGE_TAG:-0.29.35}" in compose
    ...
    def test_runtime_env_manager_creates_private_env_file(self, tmp_path: Path) -> None:
        ...
        assert "OPENINFRA_IMAGE_TAG=0.29.35" in payload
