...
Les capabilities `distributed_discovery_agents` et `installer_agent_scope` sont réservées à Enterprise. Les fonctionnalités cœur Source of Truth, DCIM, IPAM, RBAC, audit et import/export restent disponibles dans les trois éditions selon les quotas associés.
