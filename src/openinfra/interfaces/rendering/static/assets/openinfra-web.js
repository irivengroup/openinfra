import { OpenInfraI18n, localizeOpenInfraCatalog } from "./openinfra-i18n.js?v=0.30.1";
import {
  ...
  normalizeFieldValue,
  validateControl
} from "./openinfra-form-fields.js?v=0.30.1";
...
const OPENINFRA_MODULES = [
  ...
  { id: "ipam", label: "IPAM", icon: "grid", description: "IPv4/IPv6, VRF, préfixes, plages, VLAN/VXLAN, ASN/BGP, DNS/DHCP, DDI, conflits, capacité et allocations.", operations: [
    ...
    { id: "ipam-define-prefix", label: "Définir un préfixe IP", method: "POST", path: "/v1/ipam/prefixes", body: [FIELD_SETS.actor, { name: "vrf", label: "VRF", required: true, placeholder: "global" }, { name: "cidr", label: "CIDR préfixe", required: true, placeholder: "10.20.30.1/24" }, { name: "description", label: "Description", placeholder: "Réseau serveurs" }] },
    ...
    { id: "ipam-define-range", label: "Définir une plage IP", method: "POST", path: "/v1/ipam/ranges", body: [FIELD_SETS.actor, { name: "vrf", label: "VRF", required: true, placeholder: "global" }, { name: "prefix", label: "Préfixe", required: true, placeholder: "10.20.30.1/24" }, { name: "start", label: "Début plage", required: true, placeholder: "10.20.30.10" }, { name: "end", label: "Fin plage", required: true, placeholder: "10.20.30.200" }, { name: "purpose", label: "Usage plage", type: "select", options: [{ value: "allocation", label: "Allocation" }, { value: "reservation", label: "Réservation" }, { value: "exclusion", label: "Exclusion" }], defaultValue: "allocation" }, { name: "description", label: "Description", placeholder: "Pool applicatif" }] },
    { id: "ipam-register-address", label: "Enregistrer une adresse IP", method: "POST", path: "/v1/ipam/addresses", body: [FIELD_SETS.actor, { name: "vrf", label: "VRF", required: true, placeholder: "global" }, { name: "prefix", label: "Préfixe", required: true, placeholder: "10.20.30.1/24" }, { name: "address", label: "Adresse IP", required: true, placeholder: "10.20.30.21" }, { name: "hostname", label: "Nom DNS / équipement", required: true, placeholder: "srv-app-01" }, { name: "interface_name", label: "Interface", placeholder: "eth0" }, { name: "status", label: "Statut adresse", type: "select", options: [{ value: "planned", label: "Planifiée" }, { value: "reserved", label: "Réservée" }, { value: "active", label: "Active" }, { value: "deprecated", label: "Dépréciée" }], defaultValue: "reserved" }] },
    { id: "ipam-allocate", label: "Allouer une adresse IP", method: "POST", path: "/v1/ipam/allocate", body: [FIELD_SETS.actor, { name: "vrf", label: "VRF", required: true, placeholder: "global" }, { name: "prefix", label: "Préfixe", required: true, placeholder: "10.20.30.1/24" }, { name: "hostname", label: "Nom DNS / équipement", required: true, placeholder: "srv-app-01" }, { name: "idempotency_key", label: "Clé d’idempotence", required: true, placeholder: "ipam-alloc-srv-app-01" }] },
    { id: "ipam-reservation-wizard", label: "Assistant de réservation IP", method: "POST", path: "/v1/ipam/reservation-wizard", body: [FIELD_SETS.actor, { name: "vrf", label: "VRF", required: true, placeholder: "global" }, { name: "prefix", label: "Préfixe", required: true, placeholder: "10.20.30.1/24" }, { name: "hostname", label: "Nom DNS / équipement", required: true, placeholder: "srv-app-02" }, { name: "idempotency_key", label: "Clé d’idempotence", required: true, placeholder: "ipam-wizard-srv-app-02" }, { name: "apply", label: "Appliquer la réservation", type: "boolean" }] },
    { id: "ipam-capacity", label: "Calculer la capacité d’un préfixe", method: "GET", path: "/v1/ipam/capacity", query: [{ name: "vrf", label: "VRF", required: true, placeholder: "global" }, { name: "prefix", label: "Préfixe", required: true, placeholder: "10.20.30.1/24" }] },
    ...
    { id: "ipam-observe-dhcp", label: "Observer un bail DHCP", method: "POST", path: "/v1/ipam/dhcp-leases", body: [FIELD_SETS.actor, { name: "vrf", label: "VRF", required: true, placeholder: "global" }, { name: "prefix", label: "Préfixe", required: true, placeholder: "10.20.30.1/24" }, { name: "address", label: "Adresse IP", required: true, placeholder: "10.20.30.44" }, { name: "mac_address", label: "Adresse MAC", required: true, placeholder: "00:11:22:33:44:55" }, { name: "hostname", label: "Nom DHCP", required: true, placeholder: "srv-dhcp-01" }, { name: "source", label: "Source observation", placeholder: "kea" }, { name: "active", label: "Bail actif", type: "boolean", defaultValue: "true" }] },
    ...
    { id: "flow-declaration-upsert", label: "Créer ou réviser un flux déclaré", method: "POST", path: "/v1/flows/declarations/upsert", body: [
      ...
      { name: "destination_selector", label: "Sélecteur destination", required: true, placeholder: "cidr:10.20.30.1/24" },
