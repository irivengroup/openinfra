...
if len(ids) != 860:
    fail(f"expected 860 requirements, got {len(ids)}")
if ids != [f"REQ-{index:05d}" for index in range(1, 861)]:
    fail("requirements must be ordered REQ-00001 through REQ-00860")
...
print(f"OK: CDC 4.11.0, {len(ids)} requirements, {entity_count} entities, exhaustive traceability")
