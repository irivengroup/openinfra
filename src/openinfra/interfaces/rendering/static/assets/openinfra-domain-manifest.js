...
const OPENINFRA_DOMAIN_LOADERS = {
  "rsot": () => import("./domains/rsot.js?v=0.32.8"),
  "ipam": () => import("./domains/ipam.js?v=0.32.8"),
  "dcim": () => import("./domains/dcim.js?v=0.32.8"),
  "itam": () => import("./domains/itam.js?v=0.32.8"),
  "discovery": () => import("./domains/discovery.js?v=0.32.8"),
  "data": () => import("./domains/data.js?v=0.32.8"),
  "integrations": () => import("./domains/integrations.js?v=0.32.8"),
  "security": () => import("./domains/security.js?v=0.32.8"),
};
