...
const OPENINFRA_DOMAIN_LOADERS = {
  "rsot": () => import("./domains/rsot.js?v=0.32.7"),
  "ipam": () => import("./domains/ipam.js?v=0.32.7"),
  "dcim": () => import("./domains/dcim.js?v=0.32.7"),
  "itam": () => import("./domains/itam.js?v=0.32.7"),
  "discovery": () => import("./domains/discovery.js?v=0.32.7"),
  "data": () => import("./domains/data.js?v=0.32.7"),
  "integrations": () => import("./domains/integrations.js?v=0.32.7"),
  "security": () => import("./domains/security.js?v=0.32.7"),
};
