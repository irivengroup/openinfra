...
const OPENINFRA_DOMAIN_LOADERS = {
  "rsot": () => import("./domains/rsot.js?v=0.33.9"),
  "ipam": () => import("./domains/ipam.js?v=0.33.9"),
  "dcim": () => import("./domains/dcim.js?v=0.33.9"),
  "itam": () => import("./domains/itam.js?v=0.33.9"),
  "discovery": () => import("./domains/discovery.js?v=0.33.9"),
  "data": () => import("./domains/data.js?v=0.33.9"),
  "integrations": () => import("./domains/integrations.js?v=0.33.9"),
  "security": () => import("./domains/security.js?v=0.33.9"),
};
